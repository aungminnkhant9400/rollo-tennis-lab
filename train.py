...
def main() -> None:
    ...
    train_features = create_features(train_df, player_stats, recent_player_stats, adjusted_recent_player_stats)
    val_features = create_features(val_df, player_stats, recent_player_stats, adjusted_recent_player_stats)
